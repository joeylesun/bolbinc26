...
hidden_imports = [
    ...
    'cv2',
    'PIL',
    'open3d',              # For calibration
    'tkinter',             # For the Launcher UI
    # Internal Modules:
    'suvos_calibration',
    'suvos_setup',
    'suvos_working',
...
a = Analysis(
    ['suvos_launcher.py'],  # <--- ENTRY POINT IS LAUNCHER
    pathex=[],
    binaries=[],
    # 2. DATA FILES
    # ONLY include static assets (Frontend + Model)
    # DO NOT include json/npz files; they are generated at runtime now.
    datas=[
        ('interface', 'interface'),
        ('yolov8n.pt', '.')
    ],
